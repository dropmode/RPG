...
public class Main {
	public static void main(String[] args) {
		...
		Human B = new Brave("沖田総司", "剣");
		Human F = new Fighter("金太郎", "斧");
		Human W = new Wizard("安倍晴明", "魔法");
		...
		Monster S = new Slime("キングスライム", "体当たり");
		Monster O = new Oak("オークキング", "槍");
		Monster D = new Dragon("紅龍", "炎");
		...
		while (true) {
			...
			if (monster1.getHp() <= 0) {
				...
				System.out.println("★「" + monster1.getName() + "」は倒れた。");
			}
